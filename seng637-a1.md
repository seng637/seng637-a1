...
| **Lab Report**                                                                                                                                                                      |     |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| Test plan including (Check: [Test Plan Sample](media/Test_Plan_Sample.pdf)) for more information):<br>- Test Types<br>- Scope of Testing<br>- Test Logistics (Who tests each functionality) | 15% |
